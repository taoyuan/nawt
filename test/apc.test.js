...
const STATUS_INACTIVE_1 = `● create_ap.service - Create AP Service
   Loaded: loaded (/usr/lib/systemd/system/create_ap.service; disabled; vendor preset: enabled)
   Active: inactive (dead)`;

const STATUS_INACTIVE_2 = `● create_ap.service - Create AP Service
   Loaded: loaded (/usr/lib/systemd/system/create_ap.service; disabled; vendor preset: enabled)
   Active: inactive (dead)
...
const STATUS_DISABLED = `● create_ap.service - Create AP Service
   Loaded: loaded (/usr/lib/systemd/system/create_ap.service; disabled; vendor preset: enabled)
   Active: inactive (dead)`;

const STATUS_ENABLED = `● create_ap.service - Create AP Service
   Loaded: loaded (/usr/lib/systemd/system/create_ap.service; enabled; vendor preset: enabled)
   Active: inactive (dead)`;

const STATUS_ACTIVE = `● create_ap.service - Create AP Service
   Loaded: loaded (/usr/lib/systemd/system/create_ap.service; disabled; vendor preset: enabled)
